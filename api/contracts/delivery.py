...
schemas["ServiceDelivery"] = obj({"public_tcp": array(ref("PublicTCPStatus")), "aws_identity": {"anyOf": [ref("AWSIdentityState"), {"type": "null"}]}, "observed_at": T}, ["public_tcp", "aws_identity", "observed_at"])
