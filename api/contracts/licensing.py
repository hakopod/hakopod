...
schemas["LicenseFeature"] = obj({"id":{**S,"description":"Feature identifier. Paid capabilities include multi_team, oauth_login and enterprise_sso; availability comes from enabled."},"name":S,"plan":{"type":"string","enum":["free","pro"]},"description":S,"enabled":B},["id","name","plan","description","enabled"])
