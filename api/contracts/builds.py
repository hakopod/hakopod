...
schemas["BuildConfig"] = obj({"connection_id":S,"architecture":{"type":"string","enum":["amd64","arm64"]},"id":S,"application_id":S,"project":S,"environment":S,"name":S,"service":S,"repository":S,"branch":S,"mode":{"type":"string","enum":["dockerfile","buildpacks"]},"preset":{"type":"string","enum":["auto","nodejs","python","go","java","dotnet","ruby","static"]},"context_path":S,"dockerfile":S,"registry_credential":S,"port":I,"public":B,"size":S,"submodules":B,"auto_build":B,"auto_deploy":B,"revision":I,"installed_revision":I,"installed_commit":S},["connection_id","architecture","id","project","environment","name","service","repository","branch","mode","preset","context_path","dockerfile","port","public","size","auto_build","auto_deploy","revision","installed_revision","installed_commit"])
