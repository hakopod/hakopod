schemas['SourceImportInput']=obj({'project':S,'environment':S,'connection_id':S,'provider':{'type':'string','enum':['github','gitlab']},'repository':S,'branch':S,'path':S,'auto_deploy':B},['project','environment','provider','repository','branch','path','auto_deploy'])
