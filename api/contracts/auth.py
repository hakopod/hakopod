...
schemas["AuthStatus"] = obj({"setup_required":B,"password":B,"providers":array(S),"passkeys":B,"totp":B,"email_delivery":B},["setup_required","password","providers","passkeys","totp","email_delivery"])
schemas["HumanSessionCreated"] = obj({"token":S,"user":ref("Principal"),"expires_at":T},["token","user","expires_at"])
...
authroute("/auth/invites/accept","post","acceptHumanInvite",ref("HumanSessionCreated"),obj({"token":S,"name":S,"password":S},["token"]),public=True)
