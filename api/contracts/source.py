...
schemas["SourceBinding"] = obj({"application_id": S, "repository": S, "branch": S, "path": S, "auto_deploy": B, "revision": I, "last_commit": S, "last_deployment": S, "last_error": S, "updated_at": T}, ["application_id", "repository", "branch", "path", "auto_deploy", "revision", "last_commit", "last_deployment", "last_error", "updated_at"])
...
route("/applications/{id}/source", "put", "setSource", ref("SourceStatus"), obj({"repository": S, "branch": S, "path": S, "auto_deploy": B, "expected_source_revision": I}, ["repository", "branch", "path", "auto_deploy", "expected_source_revision"]))
