...
schemas["SourceBinding"] = obj({"application_id": S, "connection_id": S, "provider": {"type":"string","enum":["github","gitlab"]}, "repository": S, "branch": S, "path": S, "auto_deploy": B, "revision": I, "last_commit": S, "last_deployment": S, "last_error": S, "updated_at": T}, ["application_id", "connection_id", "provider", "repository", "branch", "path", "auto_deploy", "revision", "last_commit", "last_deployment", "last_error", "updated_at"])
...
route("/applications/{id}/source", "put", "setSource", ref("SourceStatus"), obj({"connection_id":S,"provider": {"type":"string","enum":["github","gitlab"],"default":"github"}, "repository": S, "branch": S, "path": S, "auto_deploy": B, "expected_source_revision": I}, ["repository", "branch", "path", "auto_deploy", "expected_source_revision"]))
