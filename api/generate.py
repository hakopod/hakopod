...
schemas["Plan"] = obj({"application_id": S, "expected_revision": I, "spec": ref("Spec"), "changes": array(ref("Change")), "warnings": array(S), "required_secrets": array(S), "missing_secrets": array(S), "resource_profiles": mapping(obj({"CPURequest":S,"CPULimit":S,"MemoryRequest":S,"MemoryLimit":S}))}, ["application_id", "expected_revision", "spec", "changes", "warnings"])
